...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnSlotUpdated,  const class UMounteaInventoryItem*, Item, const FString&, UpdateContext);
...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category="Mountea|Equipment")
	...
	UFUNCTION(BlueprintNativeEvent, Category="Mountea|Equipment")
	TArray<UMounteaEquipmentSlot*> GetAllSlots() const;
	virtual TArray<UMounteaEquipmentSlot*> GetAllSlots_Implementation() const = 0;
