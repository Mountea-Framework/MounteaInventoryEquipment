...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Base Class|Item", meta=(ShowOnlyInnerProperties))
	TSubclassOf<UMounteaBaseUserWidget> InventoryItemDragDropClass_DELME;
