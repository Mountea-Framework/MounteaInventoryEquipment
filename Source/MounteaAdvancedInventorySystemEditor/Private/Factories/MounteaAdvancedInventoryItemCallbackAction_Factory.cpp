...
#include "MounteaAdvancedInventoryItemCallbackAction_Factory.h"
...
UMounteaAdvancedInventoryItemCallbackAction_Factory::UMounteaAdvancedInventoryItemCallbackAction_Factory()
{
	bCreateNew = true;
	bEditAfterNew = true;

	SupportedClass = UMounteaCallbackInventoryItemAction::StaticClass();
}

UObject* UMounteaAdvancedInventoryItemCallbackAction_Factory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
...
bool UMounteaAdvancedInventoryItemCallbackAction_Factory::ConfigureProperties()
{
	static const FText TitleText = FText::FromString(TEXT("Pick Parent Class for new Mountea Inventory Callback Item Action Blueprint"));
	ParentClass = nullptr;
