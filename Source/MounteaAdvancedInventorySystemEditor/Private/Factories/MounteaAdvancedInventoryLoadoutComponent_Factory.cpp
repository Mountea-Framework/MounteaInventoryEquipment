...
#include "MounteaAdvancedInventoryLoadoutComponent_Factory.h"
...
UMounteaAdvancedInventoryLoadoutComponent_Factory::UMounteaAdvancedInventoryLoadoutComponent_Factory()
{
	bCreateNew = true;
	bEditAfterNew = true;

	SupportedClass = UMounteaAdvancedInventoryLoadoutComponent::StaticClass();
}

UObject* UMounteaAdvancedInventoryLoadoutComponent_Factory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
...
bool UMounteaAdvancedInventoryLoadoutComponent_Factory::ConfigureProperties()
{
	static const FText TitleText = FText::FromString(TEXT("Pick Parent Class for new Mountea Inventory Loadout Component Blueprint"));
	ParentClass = nullptr;
