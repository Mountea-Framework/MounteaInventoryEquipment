...
#include "MounteaAdvancedInventoryItemSelectableAction_Factory.h"
...
UMounteaAdvancedInventoryItemSelectableAction_Factory::UMounteaAdvancedInventoryItemSelectableAction_Factory()
{
	bCreateNew = true;
	bEditAfterNew = true;

	SupportedClass = UMounteaSelectableInventoryItemAction::StaticClass();
}

UObject* UMounteaAdvancedInventoryItemSelectableAction_Factory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
...
bool UMounteaAdvancedInventoryItemSelectableAction_Factory::ConfigureProperties()
{
	static const FText TitleText = FText::FromString(TEXT("Pick Parent Class for new Mountea Inventory Selectable Item Action Blueprint"));
	ParentClass = nullptr;
