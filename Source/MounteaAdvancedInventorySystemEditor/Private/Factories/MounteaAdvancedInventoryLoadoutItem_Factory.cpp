...
#include "MounteaAdvancedInventoryLoadoutItem_Factory.h"
...
UMounteaAdvancedInventoryLoadoutItem_Factory::UMounteaAdvancedInventoryLoadoutItem_Factory()
{
	bCreateNew = true;
	bEditAfterNew = true;

	SupportedClass = UMounteaAdvancedInventoryLoadoutItem::StaticClass();
}

UObject* UMounteaAdvancedInventoryLoadoutItem_Factory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
...
bool UMounteaAdvancedInventoryLoadoutItem_Factory::ConfigureProperties()
{
	static const FText TitleText = FText::FromString(TEXT("Pick Parent Class for new Mountea Inventory Loadout Item Blueprint"));
	ParentClass = nullptr;
