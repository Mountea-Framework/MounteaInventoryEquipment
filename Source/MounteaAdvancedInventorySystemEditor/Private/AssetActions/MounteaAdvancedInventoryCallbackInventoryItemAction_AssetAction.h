 ...
 * 
 */
class FMounteaAdvancedInventoryCallbackInventoryItemAction_AssetAction : public FAssetTypeActions_Base
{
public:
	FMounteaAdvancedInventoryCallbackInventoryItemAction_AssetAction();
