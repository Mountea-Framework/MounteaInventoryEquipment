...
namespace MounteaAdvancedInventoryBaseTypes
{
	inline const FText TemplatesMenuEntry =				FText::FromString(TEXT("1. Templates"));
	inline const FText InventoryBaseClassesMenuEntry =	FText::FromString(TEXT("2. Base Classes (Inventory)"));
