...
#include "K2Node_SwitchModalType.generated.h"

/**
 *
 */
UCLASS()
class MOUNTEAADVANCEDINVENTORYSYSTEMDEVELOPER_API UK2Node_SwitchModalType : public UK2Node_Switch
{
...
public:
	...
	/**
	 * List of available Modal Types.
	 * All from Global UI Config are added automatically. You can add more manually.
	 * Global UI Config based data are not possible to delete or modify.
	 */
	UPROPERTY(EditAnywhere, Category="PinOptions",
		meta=(DisplayName="Modal Types"),
		meta=(ForceInlineRow),
...
protected:
	...
	static void GetModalTypesFromSettings(TArray<FName>& OutModalTypes);
