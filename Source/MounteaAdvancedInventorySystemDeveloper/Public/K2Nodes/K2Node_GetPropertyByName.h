...
#include "K2Node.h"
#include "K2Node_GetPropertyByName.generated.h"

UCLASS()
class MOUNTEAADVANCEDINVENTORYSYSTEMDEVELOPER_API UK2Node_GetPropertyByName : public UK2Node
{
