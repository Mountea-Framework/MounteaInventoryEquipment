...
class FMounteaInventoryItemConfig_CustomDetailsHelper;

class FMounteaItemConfig_DetailsPanel : public IPropertyTypeCustomization
{
	typedef FMounteaItemConfig_DetailsPanel Self;
...
private:
	...
	TSharedPtr<FMounteaInventoryItemConfig_CustomDetailsHelper> MounteaItemConfig_CustomDetailsHelper;
};
