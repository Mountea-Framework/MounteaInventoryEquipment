...
class FMounteaInventoryItemAction_CustomDetailsHelper : public TSharedFromThis<FMounteaInventoryItemAction_CustomDetailsHelper>
{

	typedef FMounteaInventoryItemAction_CustomDetailsHelper Self;
	
public:
	
	FMounteaInventoryItemAction_CustomDetailsHelper(IDetailPropertyRow* InPropertyRow);
	virtual ~FMounteaInventoryItemAction_CustomDetailsHelper() {}
