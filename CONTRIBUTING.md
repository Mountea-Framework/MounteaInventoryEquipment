# Contributing to Mountea Dialogue System
...
1. Fork the repo and create your branch from `master` or Engine Version specific branch.
...
## Report bugs using Github's [issues](https://github.com/Mountea-Framework/MounteaInventoryEquipment/issues)
